...
public class HealthFragment extends Fragment {
    ...
    private void buildDataSet() {
        Integer[] imageList = new Integer[]{R.drawable.blood_pressure, R.drawable.blood_sugar, R.drawable.bmi};
//        String[] titleList = new String[]{"Health tips", "Travel warning"};
        String[] titleList = getResources().getStringArray(R.array.HealthArray);
        String[] aliasList = LocaleUtil.getStringArrayByLocal(getActivity(), R.array.HealthArray, LocaleUtil.ENGLISH);
    ...
    private void setRecyclerView() {
        ...
        headerImage.setImageResource(R.drawable.bg_health);
    ...
    private void findView(View rootView) {
        recyclerView = (RecyclerView) rootView.findViewById(R.id.health_recycler_view);
    }
}
